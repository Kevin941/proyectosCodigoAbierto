...
public class ReglaCalculo {
    ...
    private static void DibujaSup(BufferedImage img, int delta) {
        ...
        big.fillRect(0,0+delta, Ancho, Alto);
        big.setColor(Color.WHITE);
        big.fillRect(1,1+delta, Ancho-2, Alto-2);
        ...
        for (int i=0;i<ar1.size();i++) {
            ...
            for (int j=1;j<T1;j++) {
                img.setRGB(indice, Alto-j+delta, col1);
            }
        ...
        for (int i=0;i<ar2.size();i++) {
            ...
            int indice= (int) (Math.round(Pos)+MargenI/2.54*ppp);
            for (int j=1;j<T2;j++) {
                img.setRGB(indice, Alto-j+delta, col2);
            }
        ...
        for (int i=0;i<ar3.size();i++) {
            ...
            int indice= (int) (Math.round(Pos)+MargenI/2.54*ppp);
            for (int j=1;j<T3;j++) {
                img.setRGB(indice, Alto-j+delta, col3);
            }
        ...
        for (int i=0;i<texto.size();i++) {
            ...
            int indice= (int) (Math.round(Pos)+MargenI/2.54*ppp);
            big.drawString(texto.get(i).toString(), indice-5, Alto-31+delta);
        ...
        big.drawString("\u03c0", indice-5, Alto-25+delta);
        /*
        ...
        */
        ...
        big.drawString("e", indice-5, Alto-25+delta);
        
        
        big.setFont(new Font("Arial", Font.PLAIN, 24));
        big.drawString("A", (int) (MargenI/2.54*ppp-30), Alto-15+delta);
    ...
    private static void DibujaCentral(BufferedImage img) {
    ...
    private static void DibujaInf(BufferedImage img, int delta) {
        ...
        for (int i=0;i<ar1.size();i++) {
            ...
            for (int j=1;j<T1;j++) {
                img.setRGB(indice, j+delta, color1);
                img.setRGB(indiceK, Alto-j+delta, color1);
            }
        ...
        for (int i=0;i<ar2.size();i++) {
            ...
            int indiceK= (int) (Math.round(PosK)+MargenI/2.54*ppp);
            for (int j=1;j<T2;j++) {
                img.setRGB(indice, j+delta, col2);
                img.setRGB(indiceK, Alto-j+delta, col2);
            }
        ...
        for (int i=0;i<ar3.size();i++) {
            ...
            int indiceK= (int) (Math.round(PosK)+MargenI/2.54*ppp);
            for (int j=1;j<T3;j++) {
                img.setRGB(indice, j+delta, col3);
                img.setRGB(indiceK, Alto-j+delta, col3);
            }
        ...
        for (int i=0;i<texto.size();i++) {
            ...
            int indice= (int) (2*Math.round(Pos)+MargenI/2.54*ppp);
            int indiceK= (int) (Math.round(PosK)+MargenI/2.54*ppp);
            big.drawString(texto.get(i).toString(), indice-5, 45+delta);
            big.drawString(texto.get(i).toString(), indiceK-5, Alto-32+delta);
        ...
        for (int i=0;i<=100;i++) {
            ...
            for (int j=1;j<T3;j++) {
                img.setRGB(indice, j+Alto/2+5+delta, col3);
            }
        }
        ...
        for (int i=0;i<=100;i=i+5) {
            ...
            int indice= (int) (Pos+MargenI/2.54*ppp);
            for (int j=1;j<T2;j++) {
                img.setRGB(indice, j+Alto/2+5+delta, col2);
            }
        }
        ...
        for (int i=0;i<=100;i=i+10) {
            ...
            int indice= (int) (Pos+MargenI/2.54*ppp);
            for (int j=1;j<T1;j++) {
                img.setRGB(indice, j+Alto/2+2+delta, color1);
            }
            big.drawString(""+(i/10), indice-5, Alto/2-12+delta);
        }
        ...
        big.drawString("\u03c0", indice-5, 35+delta);
        ...
        big.drawString("e", indice-5, 35+delta);
        
        
        big.setFont(new Font("Arial", Font.PLAIN, 24));
        big.drawString("D", (int) (MargenI/2.54*ppp-30), 25+delta);
        big.drawString("K", (int) (MargenI/2.54*ppp-30), Alto-15+delta);
        big.drawString("L", (int) (MargenI/2.54*ppp-30), Alto/2+5+delta);
